...
window.PREPA = (() => {
  ...
  const DIAGNOSTIC = [
    { id: "d1", skill: "terre",
      ...
      choices: ["Triphasé uniquement", "Terre (neutre relié à la terre au transfo)", "Temporisé", "Température"], ok: 1,
    ...
    { id: "d2", skill: "terre",
      ...
      choices: ["Un court-circuit (retour par le PE)", "Un défaut 4–20 mA", "Une simple surcharge thermique", "Une coupure du neutre sans courant"], ok: 0,
    ...
    { id: "d3", skill: "terre",
      ...
      choices: ["Tableau général, coffret, interrupteur-sectionneur", "Trois galets", "Trois pompes hydrauliques", "Trois roulements"], ok: 0,
      why: "QG = distribution générale. QC = départ / coffret. INTER = isolation / consignation." },
    { id: "d4", skill: "irii",
      q: "IR (long retard) protège surtout contre :",
      choices: ["La flexion d’arbre", "Le schéma TN-C", "La surcharge (échauffement)", "Le court-circuit franc"], ok: 2,
    ...
    { id: "d5", skill: "irii",
      ...
      choices: ["160 A et 2200 A", "250 A et 2250 A", "200 A et 750 A", "125 A et 250 A"], ok: 2,
    ...
    { id: "d6", skill: "irii",
      ...
      choices: ["150 A < 200 A : ce n’est pas la cause des déclenchements", "Le disjoncteur saute forcément", "Il faut baisser IR à 100 A", "IR est trop bas"], ok: 0,
    ...
    { id: "d8", skill: "lmax",
      ...
      choices: ["2000 kVA", "400 V (composée)", "La vitesse du galet", "230 V (phase-neutre)"], ok: 3,
      why: "L’énoncé : V = tension entre phase et neutre. Prendre 400 V surestime Lmax." },
    { id: "d9", skill: "lmax",
      q: "L = 135 m et Lmax ≈ 169 m. On conclut :",
      choices: ["On ignore Ii", "L < Lmax : le CC en extrémité fait bien déclencher", "Câble trop long, pas de coupure en bout", "Il faut du 240 mm²"], ok: 1,
    ...
    { id: "d18", skill: "cycle",
      ...
      choices: ["+50 %, hors contrat", "On compare à 70 s et c’est plus court donc faux", "Exactement +5 %, limite respectée", "On a gagné 5 %"], ok: 2,
    ...
    { id: "d19", skill: "l10",
      ...
      choices: ["60 N / 10⁵", "C + P", "(C/P)³", "(C/P)^{10/3}"], ok: 3,
    ...
    { id: "d20", skill: "l10",
      ...
      choices: ["Annule L10", "Est inférieure à 0,2 mm : ce n’est pas la cause", "Explique l’usure prématurée", "Impose de changer le 24122"], ok: 1,
  ...
  const EXERCICES = [
    { id: "e1", skill: "terre", title: "Lettre C",
      ...
      type: "mcq",
      choices: ["Coffret", "Cuivre", "Combiné (PEN unique)", "Court-circuit"],
      ok: 2, hint: "PEN = neutre et protection dans le même conducteur.",
    ...
    { id: "e2", skill: "terre", title: "Défaut d’isolement",
      ...
      type: "mcq",
      choices: ["Un court-circuit (retour PE)", "Une surcharge lente seulement", "Une baisse de L10", "Rien"],
      ok: 0, hint: "Le PE est relié au neutre du transfo.",
    ...
    { id: "e7", skill: "lmax", title: "Tension V",
      ...
      type: "mcq",
      choices: ["2000 V", "400 V", "24 V", "230 V (phase-neutre)"],
      ok: 3, hint: "Définition de l’énoncé : phase-neutre.",
      corr: "230 V." },
    ...
    { id: "e21", skill: "l10", title: "Joint",
      ...
      type: "mcq",
      choices: ["Non, 0,045 ≪ 0,2", "Oui, 0,045 > 0,2", "Oui car −20 °C", "Seulement si k = 3"],
      ok: 0, hint: "Comparer les deux longueurs, même unité.",
