...
window.PREPA = (() => {
  ...
  const DIAGNOSTIC = [
    { id: "d1", skill: "hydro",
      ...
      choices: ["Pré-actionneur (pilote du distributeur)", "Pressostat", "Capteur de fin de course", "Moteur électrique"], ok: 0,
      why: "Y10…Y14 pilotent les tiroirs. Ce sont des pré-actionneurs." },
    { id: "d2", skill: "hydro",
      q: "Le pressostat B4 taré à 220 bar sert principalement à :",
      choices: ["Limiter la pression à 285 bar en permanence", "Mesurer un débit", "Détecter le seuil de pression de compactage (fin de phase / formation du pain)", "Ouvrir la porte"], ok: 2,
    ...
    { id: "d5", skill: "debit",
      ...
      choices: ["132 L/min (les deux pompes)", "220 L/min", "37 L/min seulement", "95 L/min seulement"], ok: 0,
    ...
    { id: "d18", skill: "securite",
      ...
      choices: ["S = √3 U I", "S = Q / V", "S = 2000 T + 8 (d − 14) en mm", "S = p · S_verin"], ok: 2,
    ...
    { id: "d19", skill: "securite",
      ...
      choices: ["30 mm", "14 mm", "10 m", "1800 mm"], ok: 1,
    ...
    { id: "d20", skill: "securite",
      ...
      choices: ["192.168.0.100", "192.168.0.0 ni 192.168.0.255", "192.168.0.35", "192.168.0.40"], ok: 1,
  ...
  const EXERCICES = [
    { id: "e1", skill: "hydro", title: "Rôle de B4",
      ...
      type: "mcq",
      choices: ["Il bascule quand la pression de compactage atteint le seuil (info API)", "Il mesure le débit de la pompe 95 L/min", "Il ouvre Y12", "Il limite mécaniquement à 285 bar"],
      ok: 0, hint: "Pressostat = capteur à seuil, pas limiteur.",
    ...
    { id: "e6", skill: "cycle", title: "Pilotes de l’avance",
      ...
      type: "mcq",
      choices: ["Y11", "Y12", "Y13", "Y10 et Y14"],
      ok: 3, hint: "DT1 : do / Y10 = 1 ; Y14 = 1.",
    ...
    { id: "e7", skill: "cycle", title: "Validation du pain",
      ...
      type: "mcq",
      choices: ["B2 seul", "B4 et tempo compactage", "X40 seul", "B1 et B3"],
    ...
    { id: "e14", skill: "porte", title: "Le vérin suffit-il ?",
      ...
      type: "mcq",
      choices: ["On ne peut pas conclure", "Non, 30 500 < 10 000", "Oui, 30 500 ≫ 10 000", "Seulement si g = 10"],
      ok: 2, hint: "Comparer F disponible et F nécessaire, même unité.",
    ...
    { id: "e18", skill: "cable", title: "Lettre de sélection",
      ...
      type: "mcq",
      choices: ["B", "E", "F", "C"],
      ok: 1, hint: "DT6, ligne « échelles, corbeaux, chemin perforé ».",
      corr: "E." },
    ...
    { id: "e21", skill: "securite", title: "Adresse interdite",
      ...
      type: "mcq",
      choices: ["192.168.0.255", "192.168.0.100", "192.168.0.40", "192.168.0.35"],
      ok: 0, hint: "Broadcast de 192.168.0.0/24.",
