...
window.PREPA = (() => {
  ...
  const DIAGNOSTIC = [
    { id: "d1", skill: "cinematique",
      ...
      choices: ["De même puissance", "De la même couleur sur le plan", "Du même fournisseur", "Sans mouvement relatif entre elles"], ok: 3,
    ...
    { id: "d2", skill: "cinematique",
      ...
      choices: ["Calculer LAC", "Régler un Kp", "Décorer le dossier", "Repérer les solides et les guidages avant de démonter"], ok: 3,
    ...
    { id: "d3", skill: "roulement",
      ...
      choices: ["d intérieur, D extérieur, largeur, charge dynamique C", "Prix, couleur, marque, masse", "Iz, Io, Ir, Im", "Kp, Ns, Pu, B5"], ok: 0,
    ...
    { id: "d4", skill: "roulement",
      ...
      choices: ["Choisir une lettre de câble", "Dimensionner la capacité / une durée de vie", "Mesurer une température", "Régler un disjoncteur"], ok: 1,
    ...
    { id: "d5", skill: "clavette",
      ...
      choices: ["Coder un mot image", "Transmettre un couple (et caler angulairement)", "Mesurer une température", "Limiter une pression"], ok: 1,
      why: "Entraînement en rotation + indexage. Clavettes A et B du DT7 : poulie / arbre." },
    { id: "d6", skill: "poulie",
      q: "Dans PBT SPA-A D.100 2G, le « 2G » indique :",
      choices: ["Un Kp de 2", "Deux gorges (donc deux courroies)", "Un entraxe de 2 m", "Deux pôles moteur"], ok: 1,
    ...
    { id: "d7", skill: "poulie",
      ...
      choices: ["Dans DP3 / nomenclature : 780 mm", "Dans le tableau AGMA", "Sur la carte AEY800", "Sur la plaque moteur (4 kW)"], ok: 0,
    ...
    { id: "d8", skill: "courroie",
      ...
      choices: ["Du quantum 12 bits", "De ρ acier seulement", "U et I seulement", "Des diamètres primitifs D, d et de l’entraxe E"], ok: 3,
    ...
    { id: "d9", skill: "courroie",
      ...
      choices: ["SPA 2650, 2 courroies", "SPA 2582 (déjà en stock ailleurs)", "SPC 2650, 4 courroies", "SPA 2800, 1 courroie"], ok: 0,
    ...
    { id: "d10", skill: "huile",
      ...
      choices: ["Un courant Ib = 274 A", "Un rack API n° 274", "Taille 5, 2 trains, 4 pôles, Ns = 274 min⁻¹, bride moteur B5", "Une courroie SPA 274"], ok: 2,
    ...
    { id: "d11", skill: "huile",
      ...
      choices: ["La tension 400 V", "Du quantum", "La taille et de la position de montage réelle", "Uniquement de la couleur d’huile"], ok: 2,
    ...
    { id: "d12", skill: "huile",
      ...
      choices: ["Toujours le bon volume, quelle que soit la position", "V5 taille 5", "B3 taille 5 (défaut catalogue, pas le montage réel)", "V6 taille 7"], ok: 2,
    ...
    { id: "d13", skill: "kp",
      ...
      choices: ["Classe I, Kp = 1", "Classe III, Kp = 2", "Classe II, Kp = 1,4", "Kp = 0"], ok: 2,
    ...
    { id: "d14", skill: "kp",
      ...
      choices: ["Pu / pôles respectés, Ns la plus proche, Kp choisi ≥ Kp requis", "Ns la plus loin possible et Kp < Kp requis", "Uniquement B5", "Uniquement le plus petit prix"], ok: 0,
    ...
    { id: "d16", skill: "mesure",
      ...
      choices: ["20 à 100 °C", "60 à 65 °C", "65 à 68 °C", "62 à 68 °C"], ok: 3,
    ...
    { id: "d19", skill: "mesure",
      ...
      choices: ["%M16", "%QW204.3", "192.168.0.35", "%IW105.3"], ok: 3,
    ...
    { id: "d20", skill: "mesure",
      ...
      choices: ["LAC à 2650", "Le mot image aux mots %MW1150 et %MW1151", "Ib à Iz", "Kp à 1,4"], ok: 1,
  ...
  const EXERCICES = [
    { id: "e1", skill: "cinematique", title: "Définition",
      ...
      type: "mcq",
      choices: ["Les pièces de même prix", "Les pièces sans mouvement relatif", "Les poulies seules", "Les pièces de même couleur de peinture"],
    ...
    { id: "e2", skill: "cinematique", title: "Coloriage DR1",
      ...
      type: "mcq",
      choices: ["Vert", "Bleu", "On ne colorie pas (10)", "Rouge"],
      ok: 3, hint: "Q.1-4 : bleu = (2), rouge = (10), vert = (30).",
    ...
    { id: "e5", skill: "clavette", title: "Rôle",
      ...
      type: "mcq",
      choices: ["Mesurer 65 °C", "Adresser %IW105.3", "Transmettre le couple arbre / poulie", "Limiter l’huile à 1,2 L"],
      ok: 2, hint: "Liaison d’entraînement en rotation.",
    ...
    { id: "e20", skill: "mesure", title: "Mot image",
      ...
      type: "mcq",
      choices: ["%IW105.3", "%M16", "%QW204.3", "%IW153"],
      ok: 0, hint: "Même gabarit que l’exemple DT17 : rack + position 2 chiffres + voie.",
      corr: "%IW105.3." },
