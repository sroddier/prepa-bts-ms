...
window.PREPA = (() => {
  ...
  const DIAGNOSTIC = [
    { id: "d1", skill: "cadence",
      ...
      choices: ["120", "960", "environ 69", "52"], ok: 2,
      why: "3600 / 52 ≈ 69,2 → 69 cycles complets." },
    { id: "d2", skill: "cadence",
      q: "Le taux de charge d’une installation se calcule typiquement par :",
      choices: ["puissance moteur / puissance réseau", "masse transportée / masse max admissible", "temps d’arrêt / temps de fonctionnement", "cadence demandée / capacité maximale"], ok: 3,
      why: "τ = cadence demandée / N_max. Ici 960 / N_max." },
    { id: "d3", skill: "cadence",
      q: "Une marge de taux de charge (installation non saturée) peut servir notamment à :",
      choices: ["Réaliser de la maintenance corrective sans perdre la cadence", "Réduire le coefficient d’adhérence", "Supprimer les capteurs de position", "Augmenter la masse unitaire sans frein"], ok: 0,
    ...
    { id: "d4", skill: "statique",
      ...
      choices: ["68 N", "68 000 N", "6800 N", "680 N"], ok: 2,
    ...
    { id: "d5", skill: "statique",
      ...
      choices: ["Nulle", "Égale à P sin α", "Égale au poids P", "Égale à μ · P"], ok: 2,
    ...
    { id: "d6", skill: "statique",
      ...
      choices: ["μ_frot · P", "μ_adh / μ_frot", "μ_adh · P", "P / μ_adh"], ok: 2,
    ...
    { id: "d7", skill: "statique",
      ...
      choices: ["μ_adh · P", "0", "P", "μ_frot · P"], ok: 3,
    ...
    { id: "d8", skill: "incline",
      ...
      choices: ["P cos α", "P / sin α", "P sin α", "P tan α"], ok: 2,
      why: "Parallèle au plan : P sin α. Perpendiculaire : P cos α = N." },
    { id: "d9", skill: "incline",
      q: "Si P sin α > μ_adh · P cos α, sans retenue mécanique la charge :",
      choices: ["Lévite", "A tendance à glisser", "Reste forcément immobile", "Ne peut glisser que si α > 45°"], ok: 1,
    ...
    { id: "d10", skill: "couple",
      ...
      choices: ["Mesurer la distance de la balancelle", "Positionner / retenir la luge pour empêcher le glissement", "Uniquement décoratif", "Alimenter le motoréducteur en 400 V"], ok: 1,
    ...
    { id: "d11", skill: "couple",
      ...
      choices: ["C = F · r", "C = F · 2r (toujours le diamètre)", "C = F / r", "C = m g r²"], ok: 0,
      why: "C = F · r. r = 177 mm = 0,177 m — jamais le diamètre 48 mm du pignon." },
    { id: "d12", skill: "frein",
      q: "Un mécanisme de transmission non irréversible :",
      choices: ["Se bloque toujours seul sous charge", "N’a jamais d’engrenages", "A un rendement nul", "Peut reculer sous l’effet de la charge → un frein est souvent nécessaire"], ok: 3,
    ...
    { id: "d13", skill: "frein",
      ...
      choices: ["Couples (N·m) ramenés sur le même arbre", "Ampères uniquement", "Litres d’huile", "Décibels"], ok: 0,
    ...
    { id: "d15", skill: "cinematique",
      ...
      choices: ["V = ω² r", "V = r · ω", "V = ω / r", "V = 2π r / ω"], ok: 1,
    ...
    { id: "d16", skill: "cinematique",
      ...
      choices: ["ω = 2π N", "ω = 60 N / (2π)", "ω = N / 60", "ω = (2π N) / 60"], ok: 3,
    ...
    { id: "d17", skill: "variateur",
      ...
      choices: ["50 Hz", "25 Hz", "100 Hz", "5 Hz"], ok: 1,
    ...
    { id: "d18", skill: "variateur",
      ...
      choices: ["Puissance moteur et tension du réseau", "Couleur du boîtier et masse", "Marque de l’API et longueur du câble", "Indice IP du télémètre"], ok: 0,
      why: "Ici 0,37 kW et 400 V triphasé. Le reste (calibre, CEM) vient ensuite." },
    { id: "d19", skill: "mesure",
      q: "Un signal de capteur 4–20 mA est un signal :",
      choices: ["De puissance triphasée 400 V", "Analogique de courant normalisé", "Numérique tout-ou-rien", "De freinage moteur"], ok: 1,
    ...
    { id: "d20", skill: "mesure",
      ...
      choices: ["12 000 valeurs", "12 valeurs", "1024 valeurs", "4096 valeurs"], ok: 3,
  ...
  const EXERCICES = [
    ...
    { id: "e10", skill: "incline", title: "Est-ce que ça glisse ?",
      ...
      type: "mcq",
      choices: ["Non, car μ_adh > μ_frot", "Non, 12° est trop petit", "Oui, car 1414 > 1330", "Oui, seulement si g = 9,81"],
      ok: 2,
    ...
    { id: "e19", skill: "variateur", title: "Critères de choix",
      ...
      type: "mcq",
      choices: ["ATV312H037N4", "ATV312H037M2 (mono 230 V)", "ATV312HU30N4 (3 kW)", "ATV312H075M2"],
      ok: 0,
    ...
    { id: "e22", skill: "mesure", title: "Mot image",
      ...
      type: "mcq",
      choices: ["%QW204.3", "%IW214.4", "%IW102.5", "%MW2180"],
      ok: 1,
